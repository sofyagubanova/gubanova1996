   ...
   <body>
      <div class="main-block">
         <div class="container paper">
			...
			{
			echo '
			   <form action="addtobasket_for_men.php">';
			   $is_item_added[$i]=false;
			   for ($j=0; $j<$_SESSION['basketcounter']; $j++){
			   	if ($_SESSION['item'.$j]==$productarticles[$i])
			   	{
			  	 echo '<center><input style="margin-top:5px;" type="submit" value="Добавлено в корзину" name="formen', $i, '" disabled></center>';
			   	$is_item_added[$i]=true;
			   	}
			   }
			   if ($is_item_added[$i]==false)
			   {
			   	echo ' <center><input style="margin-top:5px;" type="submit" value="Добавить в корзину" name="formen', $i, '"></center>';
			   }
			   echo '</form>';
			};
			echo'</div>';
